...
public class Member {
	...
	public Member(String userId, String password, String userName, String gender, int age, String email, String phone,
			String address, String hobby, Date enrollDate, String originalFileName, String renamedFileName,
			String studentTeacherStatus) {
		super();
		this.userId = userId;
	...
	public String toString() {
		return "Member [userId=" + userId + ", password=" + password + ", userName=" + userName + ", gender=" + gender
				...
				+ ", enrollDate=" + enrollDate + ", originalFileName=" + originalFileName + ", renamedFileName="
				+ renamedFileName + ", studentTeacherStatus=" + studentTeacherStatus + "]";
	}
